...
APIM_PUBLISHER_NAME="${APIM_PUBLISHER_NAME:-WorkCore Platform}"
APIM_PUBLISHER_EMAIL="${APIM_PUBLISHER_EMAIL:-platform@hq21.tech}"
...
az deployment group create \
  ...
  --parameters \
    ...
    apiManagementPublisherName="${APIM_PUBLISHER_NAME}" \
