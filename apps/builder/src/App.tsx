...
import {
  ...
  type HistoryWorkflowScope,
} from './ExecutionHistoryModal';
import { IntegrationKitModal } from './IntegrationKitModal';
...
export default function App() {
  ...
  return (
    ...
    >
      ...
      <ProjectEditModal
        opened={!!projectEditTarget}
        loading={projectEditLoading}
        projectName={projectEditName}
        workflowOptions={projectEditWorkflowOptions}
        defaultChatWorkflowId={projectEditDefaultChatWorkflowId}
        onClose={closeProjectEdit}
        onProjectNameChange={setProjectEditName}
        onDefaultChatWorkflowChange={setProjectEditDefaultChatWorkflowId}
        onSave={() => {
      ...
      <ProjectDeleteModal
        ...
        projectLabel={projectDeleteTarget?.project_name || projectDeleteTarget?.project_id || ''}
      ...
      <ExecutionHistoryModal
        ...
        runHistoryRaw={runHistoryRaw}
        runHistory={runHistory}
        runHistoryLoading={runHistoryLoading}
        runHistoryExpandedId={runHistoryExpandedId}
        historyWorkflowScope={historyWorkflowScope}
        historyProjectScope={historyProjectScope}
        historyInputRateUsdPer1M={historyInputRateUsdPer1M}
        historyOutputRateUsdPer1M={historyOutputRateUsdPer1M}
        onWorkflowScopeChange={setHistoryWorkflowScope}
        onProjectScopeChange={setHistoryProjectScope}
        onInputRateChange={setHistoryInputRateUsdPer1M}
        onOutputRateChange={setHistoryOutputRateUsdPer1M}
        onToggleExpanded={(runId) => {
          setRunHistoryExpandedId((previous) => (previous === runId ? null : runId));
        }}
        onRefresh={() => {
          void fetchRunHistory(workflowId);
        }}
        onOpenRunDebug={handleOpenRunDebug}
      />
      ...
      <IntegrationKitModal opened={integrationOpen} onClose={closeIntegration} links={integrationLinks} />
