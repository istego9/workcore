...
def create_app(
    ...
    async def agent_integration_kit(request: Request) -> PlainTextResponse:
        ...
        lines = [
            ...
            "",
            "## Chat Frontend Integration (Fork)",
            "Use this section when an external system embeds WorkCore chat UI or calls ChatKit directly.",
            "",
            "### Option A: embed chat-fork frontend in an external app",
            "1. Host/serve `chat-fork.html` from your builder/public frontend.",
            "2. Build iframe URL with required query params:",
            "   - `api_url` = ChatKit endpoint",
            "   - `workflow_id`",
            "   - `tenant_id`",
            "   - optional: `workflow_version_id`, `project_id`, `auth_token`, `embed=1`, `auto=1`, `auto_start=1`, `theme_pack`, `theme`",
            ...
            "- Canonical `RichChart` fields: `type`, `spec_version`, `chart_type`, `data`, optional `series`, `nivo_props`, `xAxis`, `title`, `subtitle`, `description`.",
            (
            ...
            "```",
            "",
            "### Example: RichChart donut widget payload",
            "```json",
            "{",
            "  \"type\": \"RichChart\",",
            "  \"spec_version\": \"1\",",
            ...
            "```",
            "",
            "### Example: RichChart line widget payload",
            "```json",
            "{",
            "  \"type\": \"RichChart\",",
            "  \"spec_version\": \"1\",",
            ...
            "```",
            "",
            "### Example: fallback widget when RichChart is unsupported",
            "```json",
            "{",
            "  \"type\": \"Card\",",
            "  \"children\": [",
            ...
            "  -H \"X-Tenant-Id: $TENANT\" \\",
            "  -H \"Content-Type: application/json\" \\",
            "  -d '{\"type\":\"input.transcribe\",\"metadata\":{\"workflow_id\":\"'\"$WORKFLOW_ID\"'\"},\"params\":{\"audio_base64\":\"<base64_audio>\",\"mime_type\":\"audio/webm;codecs=opus\"}}'",
            "```",
            "",
