...
2. Compose existing API/runtime contracts instead of introducing new public endpoints in v1.
...
### Tradeoffs
- Routing binding visibility remains partially observational in v1 because read/list endpoints for workflow definitions are not exposed in public API.
